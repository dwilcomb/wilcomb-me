...
import InvisibleProducts from "@/pages/invisible-products";
import RapidHire from "@/pages/rapidhire";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/invisible-products" component={InvisibleProducts} />
      <Route path="/rapidhire" component={RapidHire} />
